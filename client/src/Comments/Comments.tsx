      ...
      <form onSubmit = {sendComment}>
        ...
        <div className="commentForm flex flex-col flex-no-wrap" style={{display: (showAddComments ? 'block' : 'none')}} >
          ...
          <div className="commentForm__sectionOne">
              ...
              <div><input type="text" id="txtAuthor" name="txtAuthor" className="text rounded  border border-solid border-gray-300 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none h-8 pt-px w-40 "  maxLength={50}  /></div>
          </div>
